...
module TypeScript2 {
    export class Binder {
        ...
        public resolveBaseTypeLinks(typeLinks: TypeLink[], scope: SymbolScope) {
            var extendsList: Type2[] = null;
            if (typeLinks) {
                extendsList = new Type2[];
        ...
        public resolveBases(scope: SymbolScope, type: Type2) {
        ...
        public resolveSignatureGroup(signatureGroup: SignatureGroup, scope: SymbolScope, instanceType: Type2) {
        ...
        public bindType(scope: SymbolScope, type: Type2, instanceType: Type2): void {
            if (instanceType) {
