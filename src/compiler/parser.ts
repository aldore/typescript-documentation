...
module TypeScript {
    ...
    export class Parser {
        ...
        private parseFunctionStatements(errorRecoverySet: ErrorRecoverySet,
            ...
            if (isInline) {
            	funcDecl.fncFlags |= FncFlags.Inline;
            }
        ...
        private parseFncDecl(errorRecoverySet: ErrorRecoverySet,
            ...
            expectClosingRParen: bool,
			isInline: bool = false): AST {
        ...
        private parseClassMemberFunctionDeclaration(methodName: Identifier, minChar: number, errorRecoverySet: ErrorRecoverySet, modifiers: Modifiers) {
        	...
        	// check, if class member has inline modifier?
            var isInline = hasFlag(modifiers, Modifiers.Inline);
            ...
            var ast: AST = this.parseFncDecl(errorRecoverySet, true, isAmbient, true, methodName, false, isStatic, isAmbient, modifiers, null, true, isInline);
        ...
        private parsePropertyDeclaration(
            ...
            if ((this.currentToken.tokenId == TokenID.OpenParen) ||
                ...
                var ast = this.parseFncDecl(ers, true, requireSignature,
									   this.currentClassDefinition || this.inInterfaceDecl, text, isIndexer,
									   isStatic, (this.parsingDeclareFile || hasFlag(modifiers, Modifiers.Ambient)),
									   modifiers, null, true, hasFlag(modifiers, Modifiers.Inline));
        ...
        private parseTerm(errorRecoverySet: ErrorRecoverySet, allowCall: bool, typeContext: TypeContext, inCast: bool): AST {
            ...
            switch (this.currentToken.tokenId) {
            	...
            	case TokenID.Inline:
            		...
            		if (ast.nodeType != NodeType.FuncDecl) {
            			this.reportParseError("Cannot use 'inline' with non-function expression");
            		}

            		(<FuncDecl>ast).fncFlags |= FncFlags.Inline;
        ...
        private parseLambdaExpr(errorRecoverySet: ErrorRecoverySet, lambdaArgs: AST, skipNextRParen: bool, expectClosingRParen: bool, isInline: bool = false): AST {
        	...
        	var ast = this.parseFncDecl(errorRecoverySet, false, false, false, null, false, false, false, Modifiers.None, { preProcessedLambdaArgs: lambdaArgs }, expectClosingRParen, isInline);
            ...
            for (; ;) {
                switch (this.currentToken.tokenId) {
                    ...
                    case TokenID.EqualsGreaterThan:
                        ast = this.parseFncDecl(errorRecoverySet, false, false, false, null, false, false, false, Modifiers.None, { preProcessedLambdaArgs: ast }, false, true);
                ...
                switch (this.currentToken.tokenId) {
                    ...
                    case TokenID.Function:
                        if (this.parsingDeclareFile || isAmbient() || this.ambientModule) {
							...
							//check, if this simple function is inline?
                            ast = this.parseFncDecl(errorRecoverySet, true, false, false, null, false, false, false, modifiers, null, true, hasFlag(modifiers, Modifiers.Inline));
